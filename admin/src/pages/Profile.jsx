                                                        ...
                                                        <div className="d-flex gap-5">
                                                            <div>
                                                                <h6 className="fs-14 mb-2">
                                                                    ...
                                                                    <span className="text-0D161A fw-semibold">Admin</span>
                                                                </h6>
                                                                <h6 className="fs-14 mb-2">
                                                                    <span className="fw-normal" style={{ color: '#445B64' }}>Mobile : </span> <br />
                                                                    <span className="text-0D161A fw-semibold">+(123) 456-7890 </span>
                                                                </h6>
                                                                <h6 className="fs-14 mb-0">
                                                                    <span className="fw-normal" style={{ color: '#445B64' }}>Email : </span> <br />
                                                                    <span className="text-0D161A fw-semibold">Admin@gmail.com</span>
                                                                </h6>
                                                            </div>
                                                        </div>
                                                        <div className="d-flex gap-5">
                                                            <div className="mb-3">
                                                                <div className="d-flex justify-content-end">
                                                                    <button className="btn btn-sm rounded-2 bg-E4FFFD text-01A99A">
                                                                        Logout
                                                                    </button>
                                                                </div>
                                                            </div>
