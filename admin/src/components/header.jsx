                ...
                <div className="offcanvas-body">
                    <div className="d-flex flex-column px-1 w-100">
                        <ul className="nav nav-pills flex-column mb-auto gap-2">
                            ...
                            <li>
                                <NavLink to="/cd-admin/dashboard" className="nav-link" onClick={handleCloseOffcanvas} >
                            ...
                            <li>
                                <NavLink to="/cd-admin/user-list" className="nav-link" onClick={handleCloseOffcanvas} >
                                    <div className="sidebar-icon">
                            ...
                            <li>
                                <NavLink to="/cd-admin/all-cheques" className="nav-link" onClick={handleCloseOffcanvas} >
                                    <div className="sidebar-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                            ...
                            <li>
                                <NavLink to='/cd-admin/support' className="nav-link" onClick={handleCloseOffcanvas} >
                                    <div className="sidebar-icon">
