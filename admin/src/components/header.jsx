                    ...
                    <div className="d-flex flex-column px-1 w-100">
                        <ul className="nav nav-pills flex-column mb-auto gap-2">
                            <li>
                                ...
                                <h5 className="text-white mb-1">Admin</h5>
                                <h6 className="text-white fw-normal">admin@gmail.com</h6>
                            </li>
                            <li>
                            ...
                            <li>
                                <NavLink to="/cd-admin/all-cheques" className="nav-link">
                                    ...
                                    <span className="">All Checks</span>
                                </NavLink>
                            </li>
                            {/* <li>
