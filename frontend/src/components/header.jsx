            ...
            <div className="offcanvas offcanvas-start w-100 w-md-50 MobSidebarBg " data-bs-scroll="true" tabIndex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                <div className="offcanvas-header border-0">
                    ...
                    <button type="button" className="border-0 ms-auto bg-transparent" data-bs-dismiss="offcanvas" aria-label="Close">
                        <i className="fa-solid fa-x text-white fs-2 mb-0 fw-normal"></i>
                    </button>
                </div>
                ...
                <div className="offcanvas-body">
                    <div className="d-flex flex-column px-1 w-100">
                        <ul className="nav nav-pills flex-column mb-auto gap-2">
                            ...
                            <li>
                                <NavLink to="/checks" className="nav-link" onClick={handleCloseOffcanvas} >
                            ...
                            <li>
                                <NavLink to="/dashboard" className="nav-link" onClick={handleCloseOffcanvas}>
                                    <div className="sidebar-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" viewBox="0 0 15 16" fill="none">
                            ...
                            <li>
                                <NavLink to="/report" className="nav-link" onClick={handleCloseOffcanvas}>
                                    <div className="sidebar-icon">
                            ...
                            <li>
                                <NavLink to="/profile" className="nav-link" onClick={handleCloseOffcanvas}>
                                    <div className="sidebar-icon">
                            ...
                            <li>
                                <NavLink to='/my-ticket' className="nav-link" onClick={handleCloseOffcanvas}>
                                    <div className="sidebar-icon">
